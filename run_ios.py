...
if __name__ == "__main__":
    ...
    # 暂时注释
    mymiddleware_path = os.path.join(get_pathfile(), "ayla_public/mymiddleware.py")
    ...
    # pytest.main(["-sq", 'testSteps/loginSteps.py', "--phonetype=ios", "--alluredir", results_path])
    # pytest.main(["-sq", *handlefile["own"], "--phonetype=ios", "--alluredir", results_path])
